  ...
  theme: {
    ...
    colors: {
      ...
      primary: {
        ...
        DEFAULT: 'rgba(var(--semi-indigo-5), 1)',
      ...
      gray: {
        ...
        DEFAULT: 'rgba(var(--semi-grey-5), 1)',
      ...
      green: {
        ...
        DEFAULT: 'rgba(var(--semi-green-5), 1)',
      ...
      yellow: {
        ...
        DEFAULT: 'rgba(var(--semi-yellow-5), 1)',
      ...
      blue: {
        ...
        DEFAULT: 'rgba(var(--semi-blue-5), 1)',
      ...
      purple: {
        ...
        DEFAULT: 'rgba(var(--semi-purple-5), 1)',
      ...
      pink: {
        ...
        DEFAULT: 'rgba(var(--semi-pink-5), 1)',
